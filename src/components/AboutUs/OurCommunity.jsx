  ...
  return (
    <div className="bg-[#ED0058] flex flex-col items-center justify-center py-16 gap-8">
      ...
      <div className="flex flex-row items-center justify-center gap-8">
        <div className="bg-white flex flex-col items-center justify-center px-16 py-10 gap-2 transition-all transform hover:scale-100">
        ...
        <div className="bg-white flex flex-col items-center justify-center px-16 py-10 gap-2">
          <div className="bg-yellow-500 w-16 h-16 flex items-center justify-center rounded-full">
