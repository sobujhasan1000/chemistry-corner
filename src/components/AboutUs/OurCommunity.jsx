...
const OurCommunity = () => {
  return (
    <div className="bg-[#ED0058] flex flex-col items-center justify-center py-16 gap-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 items-center justify-center gap-8">
        <div className="bg-white flex flex-col items-center justify-center px-10 md:px-16 py-10 md:py-10 gap-2 transition-all transform hover:scale-100">
        ...
        <div className="bg-white flex flex-col items-center justify-center px-10 md:px-16 py-10 md:py-10 gap-2">
          <div className="bg-yellow-500 w-16 h-16 flex items-center justify-center rounded-full">
