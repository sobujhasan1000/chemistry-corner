...
const Location = () => {
  return (
    <Container>
      ...
      <div className="w-3/5 grid grid-cols-1 md:grid-cols-2 gap-1 md:ps-16 md:pt-24 ps-4 pt-4 pb-8">
      <div className="md:h-64 relative overflow-hidden transition duration-300 transform rounded-xl shadow-xl lg:hover:-translate-y-2 hover:shadow-2xl mx-2 my-2">
        ...
        <div className="md:h-64 relative overflow-hidden transition duration-300 transform rounded-xl  lg:hover:-translate-y-2  mx-2 my-2">
      ...
      <div className="md:w-2/5 w-full p-8 md:ps-12 md:pt-24 ">
        <h1 className="text-2xl md:text-5xl font-bold mb-4">
          Meet Singles in Your Area
        </h1>
        <p className="text-gray-500 my-12 text-xl">
          If you want to meet local singles for dating, companionship,
          friendship, or even more, you have come to the right place.
        </p>
        <button className="bg-[#ED0058] hover:bg-[#ed0057bd] text-white p-4 md:px-8 md:py-4 md:text-xl uppercase rounded flex items-center">
